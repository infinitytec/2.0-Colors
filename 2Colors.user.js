...
(function() {
    'use strict';
    //Procedures
    GM_addStyle(" path.blocklyBlockBackground[stroke='#FF3355'], .blocklyBlockBackground[stroke='#FF3355']{fill:#6d30a4 !important; stroke: white !important; stroke-width: 1px;}");
    //Motion
    ...
    //Pen
    GM_addStyle("g[data-category=Pen] > path.blocklyBlockBackground{fill:#00a375;}.blocklyDropDownDiv[data-category=Pen]{background:#00a375 !important;}");
    //Data
